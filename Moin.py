...
async def bgmi(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_text(f'🚀 𝘼𝙏𝙏𝘼𝘾𝙆 🚀\n\n💣𝙃𝙊𝙎𝙏-> {target_ip}\n💣𝙋𝙊𝙍𝙏-> {port} \n💣𝙏𝙄𝙈𝙀-> {duration}\n\n')
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if flooding_command is None:
        await update.message.reply_text('𝙏𝙊𝙋 𝙏𝙊 𝘾𝙊𝙈𝙈𝙀𝙉𝙏-> /Moin\n\n✅𝙊𝙒𝙉𝙀𝙍- @GOLEM_OWNER')
        return
...
# Update the Moin_command function to include buttons
async def Moin_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    # Create buttons
...
def main() -> None:
    ...
    application.add_handler(CommandHandler("golem", Moin_command))
